...
<!-- 
AUTHOR : Rifqisec
AUTHOR URL : http://fb.com/wekiyy007
EMAIL : rifqisec@live.com
-->
<html class="frontend">
<!-- START Head -->
<head>
    ...
    <title>RPL | STARBHAK</title>
    <meta name=viewport content="width=device-width, initial-scale=1"/>
    <meta http-equiv=content-type content="text/html;charset=utf-8"/>
    <meta http-equiv=X-UA-Compatible content="IE=edge,chrome=1">
    <meta http-equiv=content-type content="text/html; charset=utf-8"/>
    <meta name=generator content="RPL - STARBHAK FIRST GENERATION DEV! -  Profesional Apps Developper"/>
    <meta http-equiv=Content-Style-Type content="text/css"/>
    <meta name=copyright content="RPL - STARBHAK FIRST GENERATION DEV"/>
    <meta name=author content="rifqisec"/>
    <meta name=description content="Jurusan Rekayasa Perangkat Lunak SMK Taruna Bhakti Depok berdiri tahun 2012. Angkatan pertama berjumlah 36 orang .Jurusan Rekayasa Perangkat Lunak SMK Taruna Bhakti bertujuan membentuk siswa siswi untuk mampu berkreatifitas dalam bidang teknologi serta dapat berwirausaha mandiri atau menciptakan lapangan kerja."/>
    
    <meta name=keywords content="REKAYASA PERANGKAT LUNAK, SMK TARUNA BHAKTI, SEKOLAH TEKNOLOGI, RPL SMK TARUNA BHAKTI, Tutorial php, tutorial android, tutorial java, programming">

    <link rel="Shortcut Icon" type="image/ico" href="http://rpl-starbhak.com/assets/img/post/rpl.png"/><!--/ END META SECTION -->
        ...
        <div class="container">
            ...
            <div class="navbar-header navbar-header-transparent">
                ...
                <a class="navbar-brand" href="javascript:void(0);">
                    <span class="logo-figure" style=""></span>
                    <span class="logo-texat">Software Engineering</span>
                </a>
                <!--/ Brand -->
            </div>
            <!--/ END navbar header -->
        ...
        <section class="page-header page-header-block nm">
            ...
            <div class="container pt15 pb15">
                <div class="page-header-section">
                    <h4 class="title">RPL | SMK Taruna Bhakti <sub>@{{ beta }}</sub></h4>
                </div>
                <div class="page-header-section">
                    <!-- Toolbar -->
                    <div class="toolbar">
                            ...
                            <div class="table-layout">
                                <div class="col-sm-5">
                                    ...
                                    <header class="thumbnail">
                                        ...
                                        <div class="media">
                                            ...
                                            <!--/ toolbar overlay -->
                                            <img data-toggle="unveil" src="/image/background/placeholder.jpg" data-src="/image/background/blog/blog1.jpg" alt="Photo" height="100%">
                                        </div>
                                        <!--/ media -->
                                    </header>
                                    <!--/ Thumbnail -->
                                </div>
                                <div class="col-sm-7 pa15">
                                    <!-- heading -->
                                    <h3 class="section-title font-alt ellipsis mt0">I am Oz, the Great and Terrible</h3>
                                    <!--/ heading -->
                                ...
                                <article class="panel panel-minimal overflow-hidden mb0">
                                    <div class="table-layout">
                                        ...
                                        <div class="col-sm-7 pa15">
                                            <!-- heading -->
                                            <h3 class="section-title font-alt ellipsis mt0">The Scarecrow went sorrowfully</h3>
                                            <!--/ heading -->

                                            <!-- meta -->
                                            <p class="meta">
                                                <a href="javascript:void(0);">10 comment</a><!-- comments -->
                                                <span class="text-muted mr5 ml5">&#8226;</span>
                                                <span class="text-muted">In </span><a href="javascript:void(0);">Latest news</a><!-- category -->
                                                <span class="text-muted mr5 ml5">&#8226;</span>
                                                <span class="text-muted">By </span><a href="javascript:void(0);">Gordon Barker</a><!-- author -->
                                            </p>
                                            <!--/ meta -->
                                        ...
                                        <article class="panel panel-minimal overflow-hidden mb0">
                                            <div class="table-layout">
                                                <div class="col-sm-5">
                                                    ...
                                                    <header class="thumbnail">
                                                        ...
                                                        <div class="media">
                                                            ...
                                                            <div class="overlay">
                                                                <div class="toolbar">
                                                                    <a href="https://vimeo.com/7449107" class="btn btn-danger popup-vimeo" data-toggle="tooltip" title="Play Video"><i class="ico-play3"></i></a>
                                                                </div>
                                                            </div>
                                                            <!--/ toolbar overlay -->
                                                            <img data-toggle="unveil" src="/image/background/placeholder.jpg" data-src="/image/background/blog/blog2.jpg" alt="Photo" height="100%">
                                                        </div>
                                                        <!--/ media -->
                                                    </header>
                                                    <!--/ Thumbnail -->
                                                ...
                                                <div class="col-sm-7 pa15">
                                                    <!-- heading -->
                                                    <h3 class="section-title font-alt ellipsis mt0">I am a Woodman, and made of tin</h3>
                                                    <!--/ heading -->

                                                    <!-- meta -->
                                                    <p class="meta">
                                                        <a href="javascript:void(0);">15 comment</a><!-- comments -->
                                                        <span class="text-muted mr5 ml5">&#8226;</span>
                                                        <span class="text-muted">In </span><a href="javascript:void(0);">Life Style</a><!-- category -->
                                                        <span class="text-muted mr5 ml5">&#8226;</span>
                                                        <span class="text-muted">By </span><a href="javascript:void(0);">Emma Setong</a><!-- author -->
                                                    </p>
                                                    <!--/ meta -->
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="pt25 mb25">
                                                    ...
                                                    <ul class="list-unstyled">
                                                        <li class="mb5"><i class="ico-angle-right text-muted mr5"></i> <a href="javascript:void(0);">Technology</a></li>
                                                        <li class="mb5"><i class="ico-angle-right text-muted mr5"></i> <a href="javascript:void(0);">Entertainment</a></li>
                                                        <li class="mb5"><i class="ico-angle-right text-muted mr5"></i> <a href="javascript:void(0);">Life Style</a></li>
                                                        <li class="mb5"><i class="ico-angle-right text-muted mr5"></i> <a href="javascript:void(0);">Web Design</a></li>
                                                        <li class="mb5"><i class="ico-angle-right text-muted mr5"></i> <a href="javascript:void(0);">Animation</a></li>
                                                        <li class="mb5"><i class="ico-angle-right text-muted mr5"></i> <a href="javascript:void(0);">Development</a></li>
                                                    </ul>
                                                </div>
                                                <!--/ Category -->
                                                ...
                                                <div class="pt25 mb25">
                                                    <!-- Title -->
                                                    <h4 class="section-title font-alt mt0">Tags</h4>
                                                    <!--/ Title -->
                                                    <div class="btn-tag">
                                                ...
                                                <div class="pt25 mb25">
                                                    <!-- Title -->
                                                    <h4 class="section-title font-alt mt0">Text Widget</h4>
                                                    <!--/ Title -->
                                                    ...
                                                    <div class="pt25">
                                                        <!-- Title -->
                                                        <h4 class="section-title font-alt mt0">Blog Post</h4>
                                                        <!--/ Title -->
                                                        ...
                                                        <div class="tab-content panel nm">
                                                            ...
                                                            <div class="tab-pane np" id="recent">
                                                                <!-- Media list -->
                                                                <div class="media-list">
                                                                    <a href="javascript:void(0);" class="media border-dotted">
                                                                        <span class="pull-left">
                                                                        ...
                                                                        <span class="media-body">
                                                                            ...
                                                                            <!--/ meta icon -->
                                                                            <span class="media-heading">Ut enim ad minim veniam portus nam</span>
                                                                        </span>
                                                                    </a>
                                                                    <a href="javascript:void(0);" class="media border-dotted">
                                                                        <span class="pull-left">
                                ...
                                <footer role="contentinfo" class="bgcolor-dark pt25">
                                    ...
                                    <script type="text/javascript" src="/javascript/frontend/pages/blog.js"></script>
                                    <!--/ Plugins and page level script : optional -->
